...
L["PHX_TEAM_CONNECTING"] = "연결중" 
L["PHX_TEAM_PROPS"]		= "프롭들이"
L["PHX_TEAM_HUNTERS"] 	= "헌터들이"
L["PHX_TEAM_UNASSIGNED"]	= "할당되지 않음"  
L["PHX_TEAM_SPECTATOR"] 	= "관전자"	
...
L["HUD_TEAMWIN"] = "%s 승리!"
L["HUD_LOSE"] = "무승부! 모두 패배했습니다."
L["MISC_TIMELEFT"] = "남은 시간: %s"
L["MISC_GAMEEND"] = "이 라운드가 종료되면 게임이 끝납니다."

-- FRETTA: Team selection screen (F2)
L["DERMA_TEAMSELECT"] = "팀 선택"

-- FRETTA: F1 screeen
L["DERMA_RTV"] = "변경 투표 (RTV)"
L["DERMA_PHMENU"] = "Prop Hunt 메뉴"
L["DERMA_CHANGETEAM"] = "팀 변경"

-- FRETTA: Scoreboard
L["DERMA_PLAYER"] = "(%d 플레이어)"
L["DERMA_PLAYERS"] = "(%d 플레이어)"
L["DERMA_NAME"] = "이름"
L["DERMA_KILLS"] = "처치"
L["DERMA_DEATHS"] = "사망"
L["DERMA_PING"] = "핑"
...
L["CHAT_JOINED"] = " 님이 참가한 "
L["CHAT_JOINEDTHE"] = " 님이 참가한 "

L["CHAT_SWAPBALANCE"] = "%s 님이 팀 밸런스를 맞추기 위해 %s 팀으로 이동되었습니다."
L["CHAT_SWAPBALANCEYOU"] = "팀 밸런스를 맞추기 위해 다른 팀으로 이동되었습니다." -- Smile... for even in death, you have become children of Thanos
...
-- Important!
L["LANGUAGE_CHANGED"] = "선호하는 언어를 %s 으(로) 변경했습니다."

-- internal cl_menutypes section.
L["SUBTYPE_PREFERED_LANG"] = "선호하는 언어"

-- Events
L["EV_PLAYER_CONNECT"] = "%s 님이 서버에 연결했습니다."
L["EV_PLAYER_JOINED"] = "%s 님이 서버에 접속했습니다."
L["EV_PLAYER_DISCONNECT"] = "%s 님이 서버에서 퇴장했습니다. (%s)"

-- HUD elements
L["HUD_HP"] = "체력"
L["HUD_AMMO"] = "탄약"
L["HUD_MAGSEC"] = "기본무기 탄창. / 보조무기 탄창." -- Magazine Counts (separator) Secondary Magazine Counts
...
L["HUD_ROTLOCK"] = "프롭 회전 : 고정"
L["HUD_ROTFREE"] = "프롭 회전 : 자유"
L["HUD_KILLEDBY"] = "%s 님에게 죽었습니다"

L["HUD_AUTOTAUNT"] = "%d초 후 자동 도발"
L["HUD_AUTOTAUNT_ALT"] = "%d 후 자동 도발"

L["HUD_TargetID"] = "플레이어: %s (%d%%)" -- Player: <NAME> (<HEALTH>%)
...
L["MISC_PREV"] = "< 이전"
L["MISC_NEXT"] = "다음 >"
L["MISC_ACCESSDENIED"] = "접근 거부"

-- Chat messages
L["CHAT_NOPLAYERS"] = "플레이어가 충분하지 않습니다!"
L["CHAT_SWAP"] = "팀을 교대 했습니다!"

L["CHAT_SWAPTEAM_WARNING"] =
    "팀을 %dx회 변경하였습니다. (팀 변경 횟수는 최대 %dx회입니다.) 이후에는 상대 팀으로 이동할 수 없습니다."
L["CHAT_SWAPTEAM_REVERT"] = "팀 변경 횟수를 초과 했으므로 %s 팀으로 이동 할 수 없습니다."

L["CHAT_PROP_NO_ROOM"] = "해당 프롭으로 변경할 공간이 부족합니다!"

-- Notification
L["NOTIFY_IN_PROP_TEAM"] =
    "회전이 가능한 프롭 팀에 들어왔습니다. 마우스를 움직여 회전을 할 수 있습니다."
L["NOTIFY_ROTATE_NOTICE"] = "또한 (기본값) [R] 키를 눌러 회전 고정을 할 수 있습니다."

-- Custom Taunt Window
L["TM_WARNING_CT_DISABLE"] =
    "[PHX - 도발] 주의: 이 서버에서는 커스텀 도발을 사용할 수 없습니다."
L["TM_NO_TAUNTS"] = "주의: 이 카테고리에서 도발을 감지하지 못했습니다."
L["TM_PLAY_ONLY_ALIVE"] = "살아 있을 때만 커스텀 도발을 할 수 있습니다."

L["TM_WINDOW_TITLE"] = "Prop Hunt 커스텀 도발 메뉴"
L["TM_NOTICE_PLSWAIT"] = "랜덤 실행되는 도발이 끝날때까지 %s초 동안 기다리세요."
L["TM_NOTICE_PLAYPREVIEW"] = "도발 %s 미리보는 중"

L["TM_TOOLTIP_PLAYTAUNT"] = "도발 실행"
L["TM_TOOLTIP_PREVIEW"] = "도발 미리보기"
L["TM_TOOLTIP_PLAYCLOSE"] = "도발 실행 후 닫기"
L["TM_TOOLTIP_PLAYRANDOM"] = "랜덤 도발 실행"
L["TM_TOOLTIP_CLOSE"] = "닫기"
L["TM_MENU_CLOSE"] = "메뉴 닫기"

L["TM_DELAYTAUNT_NOT_EXIST"] = "선택한 도발이 서버에 없습니다."
L["TM_DELAYTAUNT_PLSWAIT"] = "%s초 동안 기다리세요!"

--[[
	PHX Menu window
]]
L["PHXM_WINDOW_TITLE"] = "Prop Hunt X - 고급 설정 & 메뉴"
L["SERVER_INFO_MOTD"] = "서버 정보 & 규칙 [MOTD]"

L["PHXM_TAB_HELP"] = "도움말 & 가이드"
L["PHXM_TAB_MUTE"] = "플레이어 음소거"
L["PHXM_TAB_PLAYER"] = "플레이어 설정"
L["PHXM_TAB_MODEL"] = "플레이어 모델 브라우저"
L["PHXM_TAB_MODEL_DISABLED"] = "플레이어 모델 브라우저 (비활성화)"
L["PHXM_TAB_ADMIN"] = "관리자 설정"
L["PHXM_TAB_ABOUT"] = "Prop Hunt X 정보"
L["PHXM_TAB_MAPVOTE"] = "맵 투표 설정"
L["PHXM_TAB_PLUGINS"]		= "애드온 / 플러그인"

L["PHXM_CVAR_CHANGED"] = "[설정] CVar %q가 %q으(로) 변경되었습니다."

--[[
	Player Mute Settings
]]
L["PHXM_MUTE_SELECT"] = "음소거할 플레이어를 선택하세요."

--[[ 
	Player Settings
]]
L["PHXM_PLAYER_OPTIONS"] = "플레이어 옵션"
L["PHXM_PLAYER_LANG"] = "언어"
L["PHXM_PLAYER_BIND"] = "할당"
L["PHXM_PLAYER_HUDSETTINGS"] = "HUD 설정"

L["PHXM_PLAYER_TAUNT_KEY"] = "랜덤 도발 키"
L["PHXM_PLAYER_TAUNTWINDOW_KEY"] = "도발 메뉴 키"
L["PHXM_PLAYER_ROTATLOCK_KEY"] = "회전 고정 키"

L["PHXM_PLAYER_TOGGLE_HALOS"] = "프롭 선택 시, 빛이 은은하게 비치는 효과 사용"
L["PHXM_PLAYER_IDNAMES"] =
    "같은 팀 플레이어의 머리 위에 이름 표시하기 (벽을 통과해서도 보임)"
L["PHXM_PLAYER_ENDROUND_CUE"] = "라운드 종료 효과음 재생"
L["PHXM_PLAYER_TAUNTMENU_AUTOCLOSE"] = "도발 창 두 번 클릭하여 자동 닫기"
L["PHXM_PLAYER_SEE_HUNTER_LINE"] =
    "관전자 모드에서 헌터의 조준점을 볼 수 있도록 선으로 표시"
L["PHXM_PLAYER_SEE_LBALL_ICONS"] = "'행운의 공' 생성 시 아이콘 표시"
L["PHXM_PLAYER_SEE_CRYSTAL_ICONS"] = "'악마의 공' 생성 시 아이콘 표시"

L["PHXM_PLAYER_USE_NEW_HUD"] = "Prop Hunt X: Enhanced HUD 사용"
L["PHXM_PLAYER_SHOW_TUTOR"] = "튜토리얼 팝업 표시 (각 Props 팀 플레이어 부활 시 2회 표시)"
L["PHXM_PLAYER_USE_NEW_CROSSHAIR"] = "커스텀 조준선 사용"
L["PHXM_PLAYER_SHOW_TEAM_TOPBAR"] =
    "좌측 상단에 생존한 팀 플레이어 전체의 상태 바 표시 (최소 4명의 플레이어가 표시됨)"

--[[
	Player model Browser Section
]]
L["QUERY_MODEL_SELECTED"] = "모델 %s 은(는) 다음 부활 시 적용됩니다."
L["QUERY_MODEL_INFO"] = "모델명: %s - 전원 사용 가능"

L["MDL_MENU_REFRESH"] = "아이콘 새로고침"
L["MDL_MENU_PREVIEW"] = "모델 미리보기"
L["MDL_MENU_MODELINFO"] = "모델 정보"

L["MISC_APPLYMDL"] = "모델 적용"

L["PHXM_MODEL_DISABLED"] =
    "저런, 이 서버는 사용자 지정 플레이어 모델 사용이 비활성화되어 있습니다!"
L["PHXM_PLAYERMODEL_SETFOV"] = "  모델 FOV 설정"

--[[
	Server Settings
]]
L["PHXM_ADMIN_OPTIONS"] = "서버 측 게임 모드 옵션 (관리자 / 소유자에게만 표시됨)"
L["PHXM_ADMIN_MUSTALIVE"] = "이 작업을 수행하려면 생존해 있어야 합니다."

--[[
	Language Override
]]
L["PHXM_ADMIN_LANGOVERRIDE"] = "언어 덮어 쓰기"

L["PHXM_ADMIN_FORCELANG"] =
    "언어 강제를 활성화 하시겠습니까? 활성 시 모든 유저는 서버에서 선택한 언어를 사용하도록 제한됩니다."
L["PHXM_ADMIN_LANGTOUSE"] = "언어 강제 활성화."
L["PHXM_ADMIN_PLAYERDEFAULTLANG"] = "처음 참가한 플레이어가 사용할 기본 언어"

-- Gameplay settings
L["PHXM_ADMIN_CUSTOM_MODEL"] = "헌터팀의 사용자 지정 모델 활성화"
L["PHXM_ADMIN_CUSTOM_MODEL_PROP"] =
    "프롭팀의 사용자 지정 모델 활성화 - 헌터팀도 활성화 해야합니다."
L["PHXM_ADMIN_TAUNT_DELAY_CUSTOM"] = "사용자 지정 도발 지연 시간 (초)"
L["PHXM_ADMIN_TAUNT_DELAY_RANDOM"] = "일반 도발 지연 시간 (초)"
L["PHXM_ADMIN_TAUNT_DELAY_AUTO"] = "자동 도발 지연 시간 (초)"
L["PHXM_ADMIN_AUTOTAUNT_ENABLE"] = "자동 도발 기능 활성화"

L["PHXM_ADMIN_NOTICE_ROTATION"] = "프롭으로 부활할 때 마다 '프롭 회전' 알림 표시"
L["PHXM_ADMIN_CAMERA_COLLIDE"] = "벽에 접촉 시 Prop 팀 카메라 활성화"
L["PHXM_ADMIN_FREEZECAM"] = "프롭팀의 고정 카메라 기능 활성화"
L["PHXM_ADMIN_FREEZECAM_HUNTER"] = "헌터팀의 고정 카메라 기능 활성화"
L["PHXM_ADMIN_PROP_COLLIDE"] = "다른 프롭팀 플레이어와 충돌 활성화"
L["PHXM_ADMIN_SWAP_TEAM"] = "매 라운드마다 팀 교대 - 비활성시 팀이 계속 유지됩니다."
...
L["PHXM_ADMIN_FORCEJOINBALANCE"] = "플레이어 참가 시 팀을 강제로 균등하게 만들기"
L["PHXM_ADMIN_ENABLETEAMBALANCE"] = "라운드 시작 시 팀을 자동으로 균등하게 만들기 (팀 밸런스)"
L["PHXM_ADMIN_PICKUP_PROPS"] =
    "소형 프롭을 픽업하도록 하시겠습니까? 0: 비허용, 1: 헌터팀 허용, 2: 프롭팀 허용, 3: 모두 허용"

L["PHXM_ADMIN_TAUNTMODES"] = "도발 모드"
L["PHXM_ADMIN_TAUNTMODE_MODE"] = "--[ 현재 도발 모드는 %d 입니다. ]--"
L["PHXM_ADMIN_TAUNTMODE0"] = "모드 [0]: F3/무작위 도발"
L["PHXM_ADMIN_TAUNTMODE1"] = "모드 [1]: C/사용자 지정 도발"
L["PHXM_ADMIN_TAUNTMODE2"] = "모드 [2]: 전체 모드"
L["PHXM_ADMIN_TAUNTSOPEN"] = "도발 창 열기"

L["PHXM_MODE_DEFAULT"] = "--[ 현재 픽업 모드는 %d 입니다. ]--"
L["PHXM_MODE0"] = "모드 [0]: 비허용"
L["PHXM_MODE1"] = "모드 [1]: 헌터팀 허용"
L["PHXM_MODE2"] = "모드 [2]: 프롭팀 허용"
L["PHXM_MODE3"] = "모드 [3]: 픽업 허용"

--[[
	Admin Developer Sections
]]
L["PHXM_ADMIN_DEVSECTION"] = "개발자 옵션 / 실험 기능"
L["PHXM_ADMIN_ROOMCHECK"] = "경계 확인을 활성화 할까요? 활성 시 물체나 벽에 끼이는 것을 방지 해줍니다."
L["PHXM_ADMIN_USENEWMKBREN"] = "Bren MK II 보너스 무기에 신형 모델 사용 (맵 재시작 필요)"
L["PHXM_ADMIN_BEVERBOSE"] = "개발자: Be Verbose 모드 활성화 - Prop Hunt X의 내부 정보 및 이벤트를 표시하도록 설정"
L["PHXM_ADMIN_SHOWPLNAMEHEAD"] = "플레이어 팀 이름이 화면에 표시되도록 하기."
L["PHXM_ADMIN_USESINGLE_FZCAM"] =
    "사운드 목록 대신 단일 고정 카메라 사운드 사용 ('ph_fc_cue_path'를 사용하여 고정 카메라 사운드 경로 확인)"
L["PHXM_ADMIN_MODELLISTINGTYPE"] =
    "이전 모델 목록 사용 : 0 = 모든 플레이어 모델 사용 (AddValidModel), 1 = 이전 모델 사용 : list.Get('PlayerOptionsModel')"
L["PHXM_ADMIN_JUMPPOWER"] = "프롭 팀에 추가 점프력 증폭"
L["PHXM_ADMIN_ENABLE_OBB"] =
...
L["PHXM_ADMIN_HLA_COMBINE"] = "HL: Alyx 콤바인 모델 지원 추가"
L["PHXM_ADMIN_TEAMBALANCE"] = "팀 밸런스 설정"
L["PHXM_ADMIN_CHANGETEAM_LIMIT"] = "팀 교체 제한 설정. -1 로 비활성화 할 수 있습니다. "
L["PHXM_ADMIN_USENEWCHAT"] =
    "새 채팅 박스 사용 (eChat) - 임시 방편으로 넣은 기능입니다. 이미 있으시다면 체크 해제하세요."
L["PHXM_ADMIN_NEWCHATPOS"] = "새 채팅 박스 위치 : 높이 (Y) 위치에서 N 픽셀만큼 뺍니다."
L["PHXM_ADMIN_RESPAWNONBLIND"] = "눈가림 시간에 부활 허용"
L["PHXM_ADMIN_RESPAWNONBLIND_TEAM"] =
    "눈가림 시간 중 특정 팀만 부활 허용: 0: 전체, 1: 헌터팀, 2: 프롭팀"
L["PHXM_ADMIN_REWSPANTIMEPERCENT"] =
    "눈가림 시간 중 부활할 수 있는 시간 퍼센트. 기본 값은 0.75 입니다. (이는 75%에 해당합니다. * 최대 눈가림 시간)"
L["PHXM_ADMIN_ALLOWRESPAWN_SPECTATOR"] = "관전 팀으로 배정 시 눈가림 시간에 부활 허용"
L["PHXM_ADMIN_ALLOWRESPAWN_TEAMCHANGE"] =
    "다른 팀으로 배정 시 눈가림 시간에 부활 허용 (비활성화 하는 것을 권장합니다.)"

--[[
	MapVote Settings
]]
L["PHXM_MV_SETTINGS"] = "맵 투표 설정"

L["PHXM_MV_ALLOWCURMAP"] = "현재 맵을 투표할 수 있도록 허용"
L["PHXM_MV_COOLDOWN"] = "맵 쿨다운 투표 활성화"
L["PHXM_MV_USE_ULX_VOTEMAPS"] = "ULX 맵 투표에서 목록을 사용 하시겠습니까? 사용하지 않으면 기본 maps/*.bsp 맵이 사용됩니다."
L["PHXM_MV_MAPLIMIT"] = "맵 투표에 선정되는 맵의 갯수."
L["PHXM_MV_TIMELIMIT"] = "투표 시 주어지는 기본 맵 투표 시간 (초)."
L["PHXM_MV_MAPBEFOREREVOTE"] = "맵이 다시 나올때까지 필요한 맵 변경 횟수"
...
L["PHXM_MV_START"] = "맵 투표 시작"
L["PHXM_MV_STOP"] = "맵 투표 중지"
--                  			  ^YOU VIOLATED THE LAW!

--[[ 
	Versioning, Credits or About section
]]
L["PHXM_ABOUT_VERSIONING"] = "버전: %s - Rev: %s"
L["PHXM_ABOUT_AUTHOR"] = "제작: %s"
L["PHXM_ABOUT_ENJOYING"] = "게임모드가 재미있으셨다면 후원하는 것도 잊지마세요!"
L["PHXM_ABOUT_UPDATE"] = "Prop Hunt X 업데이트"
-- [[ FIX ME ]] --
L["PHXM_VIEW_UPDATE_INFO"]		= "업데이트 정보 보기"
L["PHXM_CHECK_FOR_UPDATES"]		= "업데이트 확인"
L["PHXM_UPDATE_FOUND_TEXT"]		= "업데이트가 확인되었습니다. 더 자세한 정보는 콘솔을 통해 확인하시기 바랍니다.\n\n업데이트를 통해 무엇이 달라졌는지 확인하시겠습니까?"
L["PHXM_UPDATE_FOUND_TITLE"]   	= "업데이트 정보"
L["PHXM_UPDATE_FOUND_BUTTON"]   	= "업데이트 보기"
L["UPDATE_NOTIFY_MSG_NOTFOUND"]	= "업데이트를 찾을 수 없습니다. '업데이트 확인' 버튼을 먼저 클릭하세요!"
L["UPDATE_NOTIFY_MSG_TITLE"]		= "업데이트를 찾을 수 없습니다."
L["UPDATE_NOTIFY_WINDOW_TITLE"]	= "업데이트 공지"
L["UPDATE_RTBOX_APPEND"]			= "\n\n참고사항:\n현재 사용중인 버전: %s 및 수정: %s"
L["UPDATE_BTN_SEEFULL"]			= "변경사항 전체보기"
-- [[ FIX ME ]] --
...
L["PHXM_ABOUT_BTN_CHANGELOGS"] = "PHX 변경 사항"

--[[
	Late Additionals
]]
-- fretta
L["HUD_SPECTATING"] = "관전 중"
L["HUD_YOUDIED"] = "죽었습니다!"

L["CHAT_STARTING_MAPVOTE"] = "라운드가 종료되었습니다. 맵 투표를 시작합니다..."

-- This used for HUD Taunt Timer
L["HUD_PROP_TAUNT_TIME"] = "랜덤 도발"
L["HUD_PROP_CTAUNT_TIME"] = "사용자 지정 도발"

-- Plugins Section
L["PLUGINS_NO_PLUGINS"] = "플러그인이 없습니다. 여기서 플러그인을 찾아보세요!"
L["PLUGINS_BROWSE_MORE"] = "더 많은 플러그인 찾아보기"
L["PLUGINS_SERVER_HAS_NO_PLUGINS"] =
    "죄송합니다, 이 서버에는 사용자 지정 애드온 / 플러그인이 설치되어 있지 않습니다."
L["PLUGINS_SERVER_SETTINGS"] = "-- 서버 설정 --"
L["PLUGINS_CLIENT_SETTINGS"] = "-- 클라이언트 설정 --"

-- Text Entries
L["TEXTENTRY_FZ_SINGLE"] = "고정 카메라 단일 사운드 경로" -- this one is for ph_fc_cue_path command
L["TEXTENTRY_MV_PREFIX"] = "맵 투표 맵 접두사" -- the map previx for mv_mapprefix

--============= LATE ADDITION OF 29.10.21/X2Z. Please Improve your Language Here! =============--

L["MISC_GAME_ENDED"]		= "게임이 종료되었습니다."
...
L["PHXM_ABOUT_BTN_WIKI"]			= "PHX 위키 및 메뉴얼"

--[[
	Auto Taunt: Late Addition: Revision: 16.09.21/X2Z
]]

L["HUD_AUTOTAUNT_DISABLED"]		= 	"자동 도발이 비활성화되었습니다."
L["HUD_AUTOTAUNT_WAITFORUPDATE"]	=	"자동 도발 동기화 중..."
...
L["PHXM_MV_MUST_WAIT"]				= "투표를 하려면 잠시 기다려 주시기 바랍니다!"
L["PHXM_MV_VOTEINPROG"]				= "현재 진행 중인 투표가 있습니다!"
L["PHXM_MV_HAS_VOTED"]				= "이미 투표 진행에 표를 던졌습니다!"
L["PHXM_MV_ALR_IN_VOTE"]				= "이미 투표가 진행되어, 곧 맵이 변경됩니다!"
L["PHXM_MV_NEED_MORE_PLY"]			= "투표를 진행하려면 더 많은 플레이어가 필요합니다!"

--[[
	Late Addition: Revision: 16.09.21/X2Z
]]
L["PROP_PLAYERMDL_BANNED"]	= "사용자 지정 프롭 모델이 서버에서 금지되었습니다."

--[[
	Prop Menu/Prop Chooser, Revision: 16.09.21/X2Z
]]

L["PCR_USAGE_UNLIMIT"]		= "[프롭 메뉴] 사용 한도가 없는 **무제한**입니다!"
L["PCR_USAGE_COUNT"]			= "[프롭 메뉴] 사용 한도가 %d 남았습니다!"
L["PCR_PLS_WAIT"]			= "[프롭 메뉴] %d 초 동안 기다리시기 바랍니다."
L["PCR_NOROOM"]				= "[프롭 메뉴] 해당 프롭으로 변경할 공간이 부족합니다!"
L["PCR_PROPBANNED"]			= "[프롭 메뉴] 해당 프롭은 서버에서 금지되었습니다."
L["PCR_PROPBANNED_BYPCR"]	= "[프롭 메뉴] 해당 프롭은 프롭 메뉴에서 금지되어 사용이 불가합니다."
L["PCR_REACHED_LIMIT"]		= "[프롭 메뉴] 한계에 도달했습니다!"
L["PCR_STAY_ON_GROUND"]		= "[프롭 메뉴] 웅크리지 말고 가만히 서 있어야 합니다!"
L["PCR_ONLY_GROUP"]			= "[프롭 메뉴] 특정 그룹에서만 이용할 수 있는 메뉴입니다!"
L["PCR_NOT_EXIST_COUNT"]		= "선택하신 프롭이 맵 상에 존재하지 않습니다! ( %s / 4 )"
L["PCR_NOT_EXIST"]			= "선택하신 프롭이 맵 상에 존재하지 않습니다!"

-- PCR Client section, reason why there is a space because of chat.AddText between args.
L["PCR_NOTIFY_1"]			= " 이 서버에서 사용 중인 프롭 메뉴의 버전은 %s입니다! "
L["PCR_NOTIFY_2"]			= " 콘솔 또는 F1 누르기 -> [프롭 선택기 도움말] 메뉴"
L["PCR_CL_DISABLED"]			= " 해당 특성이 비활성화되었습니다."
L["PCR_CL_GROUP"]			= " 특정 그룹에서만 이용할 수 있는 메뉴입니다!"
L["PCR_CL_LIMIT"]			= " 한계에 도달했습니다!"

L["PCR_UNLIMIT_TEXT"]		= "무제한"
L["PCR_WINDOW_TITLE"]		= "PHX 프롭 메뉴"
L["PCR_HEADER_TOP"]			= "보유 중이거나 원하는 프롭을 선택하세요."
L["PCR_HEADER_MID"]			= "%s 사용 한도"
L["PCR_HEADER_BOTTOM"]		= "프롭 선택기를 사용하세요!"
L["PCR_CL_TOOLTIP_BANNED"]	= "해당 모델은 사용할 수 없습니다."
L["PCR_CL_TOOLTIP_MODEL"]	= "모델: %s"
L["PCR_CL_MENU_NOTREADY"]	= " 해당 특성은 현재 사용할 수 없습니다."
L["PCR_WINDOW_GUIDE_TTL"]	= "퀵 가이드: 프롭 메뉴 101"
L["PCR_BTN_HELP_MENU"]		= "프롭 메뉴 도움말"

L["PCR_CL_CMDUSEULX"]		= " 해당 커맨드는 사용이 불가능합니다. 'ulx propmenu'를 사용하세요!"
L["PCR_CMD_ULX_DISABLED"]	= "ulx propmenu의 커맨드는 사용이 불가능합니다. [프롭 메뉴 할당]을 누르세요."	--input.GetKeyName is impossible to access.

L["PCR_EDT_IN_USE"]			= "관리자가 해당 프롭 데이터를 수정 중입니다. 기다리시기 바랍니다!"
L["PCR_EDT_ERROR_DISABLED"]	= "[프롭 메뉴] 오류: 사용자 지정 프롭 에디션이 비활성화되었습니다!"
L["PCR_EDT_NO_RIGHTS"]		= "해당 특성에 대한 접근 권한이 없습니다."
...
L["PHXM_ADMIN_USABLE_ENT_TYPE"]		= "프롭 복제용 엔티티 유형"
L["PHXM_ADMIN_NOTIFY_ENT_TYPE"]		= "엔티티 관련 프롭은 E키를 눌러 복제할 수 없습니다. 단, 'ph_usable_prop_type'의 값이 3 혹은 4로 설정되어 있는 경우에 한하여 가능합니다."
L["NOTIFY_PROP_ENTTYPE"]				= "[E]를 눌러 상호작용 하세요, [마우스 클릭]으로 복사하세요."
L["NOTIFY_CUST_ENT_TYPE_IS_ON"]		= "[PHX] 알림: [E]를 눌러 상호작용 하세요, [마우스 클릭]으로 복사하세요."

--[[
	Custom Taunts, Revision: 16.09.21/X2Z
]]
L["TM_TAUNTS_SEARCH_NOTHING"]		= "'%s'을 포함한 도발을 찾을 수 없습니다..."
L["TM_SEARCH_PLACEHOLDER"]			= "해당 카테고리 검색 중: Enter word, lowercase & no wildcards. Empty=Show All."
L["PHXM_MSG_INPUT_IS_EMPTY"]			= "텍스트에 내용이 없거나 엔터 키를 누르지 않았습니다."
...
-- HUD
L["HUD_DECOY_ACTIVE"]                = "[%s]를 누르세요"
L["HUD_FAKETAUNT_COUNT"]             = "%ix 왼쪽"
L["HUD_FAKETAUNT_UNLI"]              = "무제한"
L["NOTICE_GRENADE_SMG_GIVEN"]        = "SMG 수류탄을 획득했습니다."

--[[
	ADMIN PANEL, Revision 10.06/2022/X2Z
]]--
L["PHXM_TAUNT_SETTINGS"]				= "도발 설정"
L["PHXM_GENERAL_SETTINGS"]			= "일반 설정"
L["PHXM_FAKE_TAUNT_SETTINGS"]		= "가짜 도발 설정"
L["PHXM_FAKE_TAUNT_ENABLE"]			= "맵에 있는 프롭 중에 무작위로 가짜 도발을 하도록 허용합니다. 사용자 지정 도발 메뉴를 통해서만 접근 권한을 얻을 수 있습니다."
L["PHXM_FAKE_TAUNT_MAXUSAGE"]		= "사용된 가짜 도발 최대 사용 가능 횟수. -1로 설정하면 횟수 제한이 사라집니다."
L["PHXM_TAUNT_RIGHT_CLICK"]		    = "우클릭하여 도발을 실행하세요. 사용자 지정 메뉴를 우클릭하면 해당 기능이 사라집니다!"

L["PHXM_TAUNT_PITCH_SETTINGS"]		= "도발 피치 설정"
L["PHXM_TAUNT_PITCH_ENABLE"]			= "도발 피치 허용"
L["PHXM_TAUNT_PITCH_RANGE_MIN"]		= "도발 피치 허용 최소 범위 지정. 1에서 99까지."
L["PHXM_TAUNT_PITCH_RANGE_MAX"]		= "도발 피치 허용 최대 범위 지정. 100에서 255까지."

L["PHXM_DECOY_SETTINGS"]				= "디코이 설치"
L["PHXM_DECOY_ENABLE"]				= "디코이 보상을 허용하시겠습니까? 보상은 라운드 동안 생존에 성공한 프롭에 한하여 1회 주어집니다. 또한, 보상 허용 이전에 설치했던 디코이에 한하여 적용됩니다."

L["PHXM_DISABLE_FOOTSTEP"]           = "프롭 팀 발소리 음소거"

L["PHXM_ADMIN_CHATSETTING"]			= "채팅창 설정"
L["PHXM_ADMIN_HUNTERBLIND"]			= "헌터 눈가림 컨트롤"

L["PHXM_ADMIN_GIVEGRENADE_NEAREND"]  = "다음 라운드 종료시 유탄이 주어지길 원하십니까? 그렇다면, 'ph_give_grenade_roundend_before_time'를 확인하세요."
L["PHXM_ADMIN_GIVEGRENADE_TIME"]     = "라운드 종료 이전 수류탄이 주어지는 시간을 초단위로 설정합니다. 일반적으로 10초에서 30초 사이의 시간이 주어집니다."

--[[
	Plugins in sh_init.lua, Revision 10.06/2022/X2Z
]]--
L["PLUG_NAME_VER"]					= "플러그인: %s | v.%s"
L["PLUG_DESCRIPTION"]				= "설명: %s"

--[[
	Taunt Pitch, Revision 10.06/2022/X2Z
]]--
L["PHX_CTAUNT_USE_PITCH"]			= "사용자 지정 도발에 피치 사용"
L["PHX_CTAUNT_RANDOM_PITCH"]			= "도발에 무작위 피치 설정"
L["PHX_RTAUNT_USE_PITCH"]			= "무작위 도발에 피치 사용 [%s]"
L["PHX_RTAUNT_RANDOMIZE"]			= "무작위 도발에 무작위 피치 설정 [%s]"
L["PHX_CTAUNT_PITCH_FOR_FAKE"]		= "가짜 도발에 피치 사용"
L["PHX_CTAUNT_RANDPITCH_FOR_FAKE"]	= "가짜 도발에 피치를 무작위로 설정"
L["PHX_CTAUNT_SLIDER_PITCH"]			= "도발 피치 슬라이더."
L["TM_TOOLTIP_FAKETAUNT"]			= "프롭 중 무작위로 가짜 도발 실행"
L["TM_PREFERRED_PITCH"]              = "선호되는 도발 피치 레벨"

--[[
	Fake Taunt, Revision 10.06/2022/X2Z
	Description: Play fake taunts on random props in the map (Not Players)
]]--
L["PHX_CTAUNT_ON_RAND_PROPS"]		= "랜덤 프롭으로 플레이 하기 (%ix)"
L["PHX_CTAUNT_ON_RAND_PROPS_UNLI"]	= "랜덤 프롭으로 플레이 하기"
L["PHX_CTAUNT_PLAYED_ON_RANDPROP"]	= "랜덤 프롭으로 도발을 실행했습니다."
L["PHX_CTAUNT_RAND_PROPS_LIMIT"]		= "한계에 도달했습니다!"
L["PHX_CTAUNT_RAND_PROPS_NOT_PROP"]  = "현재 불가능합니다."
L["PHX_CTAUNT_RANDPROP_DISABLED"]	= "가짜 도발은 현재 불가능합니다."
...
L["DECOY_PUT_SUCC"]					= "디코이가 설치되었습니다."
L["DECOY_CANT_PUT_HERE"]				= "디코이를 설치할 수 없습니다."
L["DECOY_GET_REWARD"]				= "축하합니다! 이번 라운드에 살아남아 ['디코이 프롭']을 획득했습니다!"
L["DECOY_REMINDER_GET"]              = "현재 디코이나 더미 프롭이 있습니다! 설치하여 헌터가 햇갈리게 하세요!"
L["DECOY_FRAGS_RECEIVED"]			= "디코이 낚시 성공: %s에게서 1점을 빼앗아옵니다!"
L["DECOY_DISABLED"]					= "현재 디코이 사용이 불가능합니다."
L["PHXM_CL_DECOY_KEYBIND"]			= "디코이 설지 기본 키. 기본 값은 숫자 키 1 입니다. (키패드에 있는 숫자 키 1이 아닙니다)."

L["DECOY_INDICATOR_INVALID"]         = "유효하지 않은 슬로프입니다!"
L["DECOY_INDICATOR_TOOFAR"]          = "범위가 너무 멀리 설정되었습니다!"
L["DECOY_INDICATOR_OK"]              = "디코이 설치 [%s를 누르세요]"

L["PHXM_DECOY_HEALTH"]				= "디코이의 체력을 설정합니다. 기본 값은 10입니다."
L["PHXM_PLAYER_SHOW_DECOY_HELPER"]   = "디코이 설치 도우미를 보이게 하거나/숨깁니다. 사용 시 조준점 주변에 텍스트와 함께 흰 점이 표시됩니다."
L["PHXM_PLAYER_SHOW_DECOY_MARKER"]   = "디코이 마커를 보이게 하거나/숨깁니다"

--[[
	Revision 10.06/2022/X2Z
    Prop Menu Update: Menu, Editor, Browser
]]--
L["PCR_MODEL_DONT_EXISTS"]   = "죄송합니다, 이 모델은 현재 사용이 불가능합니다!"

L["PCR_PLUG_WARN_MSG"]		= "경고: 사용자 지정 프롭 애디션(pcr_allow_custom) 값이 0으로 설정되어 있습니다.\n사용자 지정 프롭을 편집하기 위해서 반드시 필요한 설정입니다!\n해당 설정을 적용하기 위해서는 맵 변경이 필요합니다."
L["PCR_PLUG_LBL_BINDKEY"]	= "바인드 키를 변경하려면 '[플레이어] 텝으로 변경하세요."
L["PCR_PLUG_LBL_EDITOR"]		= "사용자 지정 프롭 메뉴 에디터"
L["PCR_PLUG_BTN_OPEN_EDT"]	= "에디터 열기"
L["PCR_PLUG_LBL_COMSET"]		= "기본 설정"
L["PCR_PLUG_LBL_TECHSET"]	= "고급 설정"
L["PCR_PLUG_LBL_EXPSET"]		= "실험"
L["PCR_PLUG_LBL_PLAYERSET"]	= "플레이어 설정"

L["PCR_PLUG_ENABLE"]			= "'프롭 메뉴' 특성 활성화"
L["PCR_PLUG_ALLOW_CUSTOM"]	= "(맵 변경 필요) 프롭 메뉴 목록에 사용자 지정 프롭 추가를 허락합니다."
L["PCR_PLUG_PROP_BAN"]		= "(맵 변경 필요) 프롭 메뉴 목록에 금지 프롭을 제외합니다."
L["PCR_PLUG_USAGE_LIMIT"]	= "플레이어 최대 사용 빈도 제한. -1 값은 제한 없음을 나타냅니다."
L["PCR_PLUG_PROP_LIMIT"]		= "(맵 변경 필요) 프롭 메뉴 목록에 추가할 프롭 수를 제한합니다."
L["PCR_PLUG_PROP_LIMITMAX"]	= "프롭 메뉴 목록에 추가할 최대 프롭 수 제한. 안내: 프롭이 무작위로 추가됩니다!"
L["PCR_PLUG_USE_ULXMENU"]	= "콘솔 (0) 또는 ULX (1)를 통한 프롭 메뉴 접속을 허용하시겠습니까? 해당 설정은 바운딩 키 적용이 가능합니다."
L["PCR_PLUG_USE_DELAY"]		= "플레이어가 다른 프롭을 사용하기 위해 프롭 메뉴 사용 시 시간을 지연시킵니다."
L["PCR_PLUG_KICK_INVALID"]	= "허용되지 않은 모델을 사용하는 유저를 추방합니다."
L["PCR_PLUG_SPACE_CHECK"]	= "프롭 변경으로 인한 끼임 현상을 방지하는 데 필요한 공간을 미리 확인합니다."
L["PCR_PLUG_X_BBOX"]			= "(맵 변경 필요) 프롭 메뉴 목록을 추가하기 전에 BBox 엔티티 제한을 확인합니다."
L["PCR_PLUG_X_BBOX_MAX"]		= "BBox 충돌 경계 최대 높이 제한. 최소 높이는 자동으로 측정됩니다."
L["PCR_PLUG_X_BBOX_MIN"]		= "BBox 충돌 경계 최대 너비 제한. 최소 높이는 자동으로 측정됩니다."
L["PCR_PLUG_ONLY_GROUPS"]	= "프롭 메뉴 접근 권한을 특정 그룹에 부여합니다. 예시, 후원자"
L["PCR_PLUG_NOTIFYMSG"]		= "매 라운드 시작마다 프롭 메뉴 사용법 알림이 뜹니다."

L["PCR_EDITOR_MSG_ERROR"]	= "변경 사항이 오류로 인해 저장되었습니다.\n서버 콘솔을 확인하시기 바랍니다!"
L["PCR_EDITOR_MSG_SUCC"]		= "변경 사항 및 사용자 지정 프롭 데이터가 저장 및 업데이트되었습니다."

L["PHZ_generic_title"]		= "사용자 지정 프롭 추가 에디터"
...
%s
Has Physics: %s]]
L["PHZ_generic_mdlinfoStart"] = "(모델을 먼저 선택하세요!)"

L["PHZ_generic_no_ragdoll"]	= "레그돌: 불가"
L["PHZ_generic_titlelabel"]	= "%s 미리보기 :"

L["PHZ_mount_game_sel"]		= "탑재된 게임 선택 (기본 설정: Garry's Mod)"
L["PHZ_input_placeholder1"]	= "폴더 검색: <폴더명> 또는 '*', 폴더 전체 여백."
L["PHZ_input_placeholder2"]  = "애드온 검색: <이름> 또는 '*', 폴더 전체 여백."
L["PHZ_msg_warn_close"]		= "정말로 이 창을 닫으시겠습니까? 저장하지 않은 편집 내역이 사라집니다!"
L["PHZ_msg_commit"] 			= "정말로 커밋을 변경하시겠습니까?"
L["PHZ_msg_cant_empty"]		= "프롭 목록은 비워둘 수 없습니다!"
...
L["PHZ_msg_warn_mdlinlist"]  = "경고: 이 모델은 이미 목록에 있습니다!"
L["PHZ_msg_invalid_mdl"] 	= "사유: 유효하지 않은 모델입니다"
L["PHZ_apply_select"] 		= "적용 및 저장 선택"
L["PHZ_menu_copy"] 		= "모델 복사"
L["PHZ_menu_refresh"] 	= "모델 새로고침"
L["PHZ_tooltip_removesel"]	= "선택 항목 삭제"
L["PHZ_tooltip_wasmarked"] = [[표시된 프롭은 더 이상 서버에 존재하지 않습니다. 에디터 종료 시, 자동으로 삭제됩니다.]]

L["PHZ_pcr_fb_allcontent"] = "모든 콘텐츠 (서버나 플레이어 모두가 동일한 콘텐츠를 소장하고 있는 것은 아닙니다.)"
L["PHZ_pcr_fb_notmounted"] = "%s [탑재되지 않음]"
