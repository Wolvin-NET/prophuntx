...
LANG["PHXM_ADMIN_NOTPUNSTUCKINROUND"]	= "Отключить телепортацию из последнего резерва в точки возрождения вне фазы прятания"
LANG["PHXM_ADMIN_UNSTUCK_WAITTIME"]		= "Сколько секунд должно пройти между каждой попыткой телепортации"
LANG["PHXM_ADMIN_TEAMBAL_ORIG"] 		= "Использовать оригинальную автоматическую балансировку PH:X (отключает все следующие ниже опции, связанные с командой)"
LANG["PHXM_ADMIN_TEAMBAL_UNCHECK"] 		= "Снимите предыдущий флажок, чтобы получить доступ к расширенным параметрам баланса команд." --[UNUSED]
LANG["PHXM_ADMIN_FORCESPECTOPLAY"]		= "Принудить наблюдателей играть, включая их при балансировке команд"
LANG["PHXM_ADMIN_NO_H_CONSECUTIVE"]		= "Запретить игрокам быть охотником дважды подряд (работает только в режиме перемешки)"
LANG["PHXM_ADMIN_HUNTER_COUNT"] 		= "Количество охотников (0 = автоматически)"
LANG["PHXM_ADMIN_ROTATETEAM"] 			= "Отключить режим перемешки и вместо этого чередовать игроков"
LANG["PHXM_ADMIN_RESET_ROTTEAM"] 		= "Сбросить чередовку"
LANG["PHXM_ADMIN_RESET_ROTTEAM_WARN"]	= "Перезапуск чередовки с самого начала (в случае, если вы начали чередовку, остановились, затем снова начали, и текущая чередовка вас не удовлетворяет):"
LANG["PHXM_ADMIN_RESET_MSG"]			= "Командная чередовка была перезагружена!"
LANG["PHXM_ADMIN_FORCEH2P_WARN"]		= "Принудить охотника в следующий раз стать объектом (работает только в режиме перемешки):"
LANG["PHXM_ADMIN_FORCEH2P_RANDONLY"]	= "Это действие доступно только в режиме перемешки."
LANG["PHXM_ADMIN_FORCEH2P_NOHUNT"]		= "[ОХОТНИКОВ НЕТ]" --[UNUSED]
LANG["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"] 	= "Охотников нет, чёрт возьми, это написано на кнопке!" --[UNUSED]
...
LANG["PHX_TP_ADJUSTVIEW_BTN"]	= "Настройка вида от третьего лица"
...
LANG["ANG_AXIS_DIST"]	= "Расстояние"
LANG["ANG_AXIS_RIGHT"]	= "Вправо"
LANG["ANG_AXIS_UP"]		= "Вверх"
LANG["VEC_POS_LEFT"]	= "Влево"
LANG["VEC_POS_FRONT"]	= "Вперёд"
LANG["VEC_POS_TOP"]		= "Вверх"
-- Key Hints
