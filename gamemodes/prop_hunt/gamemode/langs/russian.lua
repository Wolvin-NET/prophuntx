...
LANG["PHXM_ADMIN_CUSTOM_MODEL"]				= "Включить пользовательские модели для охотников. Это приведёт к включению вкладки [Браузер моделей]."
LANG["PHXM_ADMIN_CUSTOM_MODEL_PROP"]		= "Включить пользовательские модели для объектов (Требуется, чтобы пользовательские модели охотников были включены)"
...
LANG["PHXM_ADMIN_FORCEJOINBALANCE"]			= "Принудительно выравнивать команды игроков при вступлении (Отключите эту функцию, если включена функция ЧЕРЕДОВАНИЯ КОМАНД)"
LANG["PHXM_ADMIN_ENABLETEAMBALANCE"]		= "Включить баланс команд: Автоматически выравнивать команды в начале раунда."
...
LANG["PHXM_ADMIN_DEVSECTION"]		        = "Параметры разработчика"
...
LANG["PHXM_ADMIN_MODELLISTINGTYPE"]         = "Метод составления списка моделей игроков: 0: Включить все, 1: Использовать list.Get('PlayerOptionsModel')"
...
LANG["PHXM_ADMIN_EXPERIMENTALPHX"]			= "Экспериментальные материалы Prop Hunt: X"
LANG["PHXM_ADMIN_HLA_COMBINE"]				= "Добавить поддержку модели солдата Альянса из HL: Alyx"
LANG["PHXM_ADMIN_TEAMBALANCE"]				= "Основные настройки команд"
...
LANG["PHXM_MV_USE_ULX_VOTEMAPS"]	        = "Использовать список карт из ULX? Если нет, по умолчанию maps/*.bsp будут использованы."
...
LANG["PHXM_MV_EXPLANATION2"]		        = "если установлен ULX, используйте 'ulx map_vote' вместо этого. В противном случае используйте 'mv_start' для обычного вызова."
LANG["PHXM_MV_EXPLANATION3"]		        = "Действие голосования за карту (Чтобы отменить, просто используйте 'ulx unmap_vote' или 'mv_stop' в консоли)."
...
LANG["PCR_PLUG_X_BBOX"]			        = "(Требуется перезапуск карты) Проверять лимит коробки столкновений энтити перед добавлением в список меню объектов"
LANG["PCR_PLUG_X_BBOX_MAX"]		        = "Максимальный предел высоты коробки столкновений. Минимум будет автоматически рассчитан."
LANG["PCR_PLUG_X_BBOX_MIN"]		        = "Максимальный предел ширины коробки столкновений. Минимум будет автоматически рассчитан."
...
LANG["PHX_ADMIN_ACCESS_ONLY"]		= "Доступ запрещён: только администраторы могут это делать, %s !"
LANG["PHX_PROP_TOO_THIN"]           = "Невозможно перевоплотиться: Объект слишком тонкий!"
LANG["PHX_PROP_IS_BANNED"]			= "Объект, который вы пытаетесь использовать, запрещён на сервере!"
LANG["PHX_SPECT_JOINGAME"]			= "Чтобы присоединиться к игре, нажмите [F2], затем выберите команду, к которой хотите присоединиться."
LANG["PHX_TEAM_IS_FULL"]			= "Команда укомплектована!"
LANG["FORCE_JOIN_TEAM_IS_DISABLED"]	= "Равномерный баланс команды отключён (перемешивание/чередовка команд включено)"

LANG["PHX_TM_MNBAR_OPTIONS"]		= "Настройки"
LANG["PHX_TM_MNBAR_SAVEFAV"]		= "Сохранить избранное"
LANG["PHX_TM_MNBAR_LOADFAV"]		= "Перезагрузить избранное"
LANG["PHX_TM_MNBAR_SETTINGS"]		= "Другое"
LANG["PHX_TM_MNBAR_RESET"]			= "Сброс избранного"

LANG["PHX_TM_WARN_CLEARFAV"]		= "ВНИМАНИЕ: Это очистит ВСЕ ваши ранее сохранённые избранные насмешки. Вы уверены, что хотите продолжить?"

LANG["PHXM_BANNED_MODELS"]			= "Запретить/разрешить использование ограниченных моделей (Запрещённых моделей). Это не относится к запретным моделям (они всегда удаляются)."
LANG["PHXM_ADMIN_ALLOWARMOR"]       = "Разрешить добавление брони для команды охотников и объектов"
LANG["PHXM_ADMIN_ALLOW3P"]          = "Разрешить режим третьего лица для охотников"
LANG["PHXM_ADMIN_ALLOW3P_SVDESIRED"]= "Разрешить режиму от третьего лица использовать желаемую позицию камеры сервера (запретить пользовательскую позицию игрока)"
LANG["PHXM_ADMIN_ALLOW3P_DIST"]     = "Третье лицо: Желаемое расстояние до камеры"
LANG["PHXM_ADMIN_ALLOW3P_RIGHT"]    = "Третье лицо: Желаемое положение камеры вправо"
LANG["PHXM_ADMIN_ALLOW3P_UP"]     	= "Третье лицо: Желаемое положение камеры вверх"
LANG["PHXM_ADMIN_JUMPPOWER_H"]		= "Дополнительный множитель прыжка для охотников"
LANG["PHXM_ADMIN_MDLCOLOR_PROP"]	= "Включить цвет игрока для команды объектов (требуется включить пользовательские модели охотников)"
LANG["PHXM_ADMIN_MDLCOLOR_HUNTER"]	= "Включить цвет игрока для команды охотников (требуется включить пользовательские модели охотников)"
LANG["PHXM_ADMIN_PITCH_ROTATION"]	= "[Экспериментально] Разрешить использовать шаг вращения для объектов. Это может вызывать проблемы."
LANG["PHXM_ADMIN_FALLDMG"]			= "Включить повреждения при падении (применяется ко всем командам)"
LANG["PHXM_ADMIN_FALLDMG_REAL"]		= "Включить реалистичные повреждения при падении"
LANG["PHXM_INFORM_TO_JOIN"]			= "Информировать неназначенных/наблюдателей статичным текстовым советом присоединиться к игре."
LANG["PHXM_ADMIN_PROPOFFSET"]		= "Вычитать/Добавлять высоту смещения с помощью множителя. Мин.: 0,6, Макс.: 1,2. По умолчанию: 0,8."
LANG["PHXM_ADMIN_REPL_MUST_STAND"]	= "[Экспериментально] Ограничить перевоплощение объекта до состояния - только когда он стоит. Отключите этот параметр, чтобы разрешить перевоплощение при прыжке или пригнувшись."

LANG["PHXM_DROP_VBS_DISABLE"]       = "Отключить подробную информацию"
LANG["PHXM_DROP_VBS_ENABLE"]        = "Включить подробную информацию"
LANG["PHXM_DROP_MDL_INCLUDEALL"]    = "Включать всё ( %d )"
LANG["PHXM_DROP_MDL_CUSTOMLIST"]    = "Отдельный/польз. список ( %d )"
LANG["PHXM_DROP_MDLTYPE_PROP"]      = "Только физические ( %d )"
LANG["PHXM_DROP_MDLTYPE_PROPDYN"]   = "Физические и динамические объекты ( %d )"
LANG["PHXM_DROP_MDLTYPE_ANYENTS"]   = "Любые совместимые энтити ( %d )"
LANG["PHXM_DROP_MDLTYPE_CUSTOM"]    = "Пользовательские энтити ( %d )"
LANG["PHXM_DROP_RESPAWNBLIND_BOTH"] = "Обе команды"

LANG["PHXM_TAB_ADMINGROUPS"]        = "Группа и параметры доступа"
LANG["PHXM_TAB_PHEPLUS"]			= "Настройки версии Enhanced Plus"

LANG["PHXM_ADMIN_ACCESS_GROUP"]     = "Выберите группы, чтобы разрешить доступ к странице НАСТРОЙКИ АДМИНИСТРАТОРА PH:X, Enhanced Plus И НАСТРОЙКИ ПЛАГИНОВ."
LANG["PHXM_ADMIN_ACCESS_GROUP_HINT"] = "Обратите внимание, что привелегия \"суперадмина\" не может быть отозвана."
LANG["PHXM_ADMIN_ACCESS_GROUP_NOULX"] = "Ошибка: ULib и ULX не установлены на вашем сервере."
LANG["PHXM_ADMIN_ACCESS_NOREVOKE"]  = " (Не может быть отозван)"
LANG["PHXM_ADMIN_GROUP_WHOCANACC"]	= "Выберите группы для разрешения доступа [Настройки администратора]."
LANG["PHXM_ADMIN_GROUP_MUTEABLE"]	= "Выберите группы для отключения заглушения голоса в [Заглушить игроков]. (Пользователь всегда может быть заглушен)."

LANG["PHXM_ADMIN_ACCESS_CHATINFO"]  = "Произошло обновление конфигурации для окна меню Prop Hunt. Повторное открытие..."
LANG["PHXM_ADMIN_ACCMSG_BODY"]      = "Вы хотите сохранить выбор и применить изменения?\nПримите во внимание, что все предыдущие группы, у которых вы отозвали доступ, больше не будут иметь его.\nЭто перезапустит меню Prop Hunt, если оно всё ещё открыто."
LANG["PHXM_ADMIN_ACCMSG_TITLE"]     = "Применить доступ группы"
LANG["PHXM_ADMIN_ACCCFG_SUCC"]      = "Данные доступа группы успешно сохранены."
LANG["PHXM_ADMIN_ACCCFG_FAIL"]      = "Произошла ошибка при сохранении данных доступа группы. Проверьте консоль вашего сервера!"
LANG["PHXM_ADMIN_MUTCFG_SUCC"]      = "Данные о доступе групп с возможностью заглушения успешно сохранены."
LANG["PHXM_ADMIN_MUTCFG_FAIL"]      = "Произошла ошибка при сохранении данных групп с возможностью заглушения. Проверьте консоль вашего сервера!"

LANG["PHXM_ADMIN_ACCESS_APPLY"]     = "Применить выбранные группы"

-- PHE/Plus
LANG["PHXM_ADMIN_PLUSSETTING"]		= "Настройки Plus+"
LANG["PHXM_PLUSSETTING_HINT"]		= "Настроить баланс команд или любые другие дополнительные параметры."
LANG["PHXM_HEADER_UNSTUCK"]			= "Настройки при застревании"
LANG["PHXM_HEADER_TEAMSETTING"]		= "Больше параметров и настроек команды"

LANG["LIST_PLAYER"]					= "Игроки"
LANG["LIST_FORCEDASPROP"]			= "Принудительно в качестве объекта?"
LANG["LIST_MARKEDASPROP"]			= "Отмечен как «принудительно в качестве объекта»"
LANG["LIST_NOHUNTERS"]				= "Сейчас ни один охотник не играет."

LANG["PHXM_PLUS_MSG_NO_HUNTERS"]	= "Охотников на сброс нет."

LANG["PHXM_PLUS_BTNRESET"]			= "Очистить выбор (и сбросить всё принудительно)"
LANG["PHXM_PLUS_LISTTIPS"]			= "Советы: Дважды щёлкните, чтобы включить функцию принудительного выбора."

LANG["PHXM_ADMIN_ENABLEUNSTUCK"]		= "Переключение включение/отключение встроенной функции телепортации при застревании. Если вы используете дополнение, отключите эту функцию."
LANG["PHXM_ADMIN_NOTPUNSTUCKINROUND"]	= "Отключить телепортацию из последнего резерва в точки возрождения вне фазы прятания" --ph_disabletpunstuckinround
LANG["PHXM_ADMIN_UNSTUCK_WAITTIME"]		= "Сколько секунд должно пройти между каждой попыткой телепортации" --ph_unstuck_waittime
LANG["PHXM_ADMIN_TEAMBAL_ORIG"] 		= "Использовать оригинальную автоматическую балансировку PH:X (отключает все следующие ниже опции, связанные с командой)" --ph_originalteambalance
LANG["PHXM_ADMIN_TEAMBAL_UNCHECK"] 		= "Снимите предыдущий флажок, чтобы получить доступ к расширенным параметрам баланса команд." --ph_originalteambalance_uncheck [UNUSED]
LANG["PHXM_ADMIN_FORCESPECTOPLAY"]		= "Принудить наблюдателей играть, включая их при балансировке команд" --ph_forcespectatorstoplay
LANG["PHXM_ADMIN_NO_H_CONSECUTIVE"]		= "Запретить игрокам быть охотником дважды подряд (работает только в режиме перемешки)" --ph_preventconsecutivehunting
LANG["PHXM_ADMIN_HUNTER_COUNT"] 		= "Количество охотников (0 = автоматически)" --ph_huntercount
LANG["PHXM_ADMIN_ROTATETEAM"] 			= "Отключить режим перемешки и вместо этого чередовать игроков" --ph_rotateteams
LANG["PHXM_ADMIN_RESET_ROTTEAM"] 		= "Сбросить чередовку" --ResetRotateTeams
LANG["PHXM_ADMIN_RESET_ROTTEAM_WARN"]	= "Перезапуск чередовки с самого начала (в случае, если вы начали чередовку, остановились, затем снова начали, и текущая чередовка вас не удовлетворяет):" --ResetRotateTeams_warning
LANG["PHXM_ADMIN_RESET_MSG"]			= "Командная чередовка была перезагружена!"
LANG["PHXM_ADMIN_FORCEH2P_WARN"]		= "Принудить охотника в следующий раз стать объектом (работает только в режиме перемешки):" --ForceHunterAsProp_warning
LANG["PHXM_ADMIN_FORCEH2P_RANDONLY"]	= "Это действие доступно только в режиме перемешки." --ForceHunterAsProp_randomonly
LANG["PHXM_ADMIN_FORCEH2P_NOHUNT"]		= "[ОХОТНИКОВ НЕТ]" --ForceHunterAsProp_nohunters [UNUSED]
LANG["PHXM_ADMIN_FORCEH2P_NOHUNTMSG"] 	= "Охотников нет, чёрт возьми, это написано на кнопке!" --ForceHunterAsProp_nohuntersmsg [UNUSED]

LANG["FORCEH2P_WILL_BE"]				= "%s будет объектом в следующем раунде."
LANG["FORCEH2P_IS_CANCELED"]			= "%s не будет объектом в следующем раунде."
LANG["FORCEH2P_IS_RESET"]				= "В следующем раунде все охотники принудительно не будут объектами."
LANG["FORCEH2P_PLAYER_NOT_FOUND"]		= "Выбранный игрок не найден, возможно, он покинул игру."
LANG["PHX_ROTATE_TEAM_RESET"]			= "Смещение командной чередовки было сброшено."
LANG["FORCEH2P_ALREADY"]				= "%s уже определён как объект для следующего раунда." -- [UNUSED]

LANG["UNSTUCK_YOURE_UNSTUCK"]			= "Вы должны уже быть свободны!"
LANG["UNSTUCK_BAD_SPAWNPOINT"]			= "Ошибка: Ближайшая точка возрождения может привести к повторному застреванию. Если это произойдёт, попробуйте выбраться снова."
LANG["UNSTUCK_RESCUE_SPAWNPOINT"]		= "Эта точка возрождения находится очень близко, поэтому вы всё ещё можете застрять. Если вы застряли, попробуйте выбраться снова."
LANG["UNSTUCK_NO_SPAWNPOINTS"]			= "По неизвестным причинам не удалось найти точку возрождения. В качестве запасной стратегии вы будете телепортированы на (0, 0, 0). Вероятность того, что вы застрянете, очень высока, поэтому если вы застряли, пожалуйста, попробуйте освободиться снова."
LANG["UNSTUCK_PLEASE_WAIT"]				= "Пожалуйста, подождите %d сек. между каждой попыткой телепортации."
LANG["UNSTUCK_NOT_ON_GROUND"] 			= "Не на земле, проверка..."
LANG["UNSTUCK_NOT_STUCK_JITTER"]		= "Вы не застряли. Если вы действительно застряли, подождите, пока ваш объект не перестанет двигаться/дрожать (попробуйте нажать ALT), а затем попробуйте снова."
LANG["UNSTUCK_NOT_STUCK_TOOBAD"]		= "Вы не застряли. Если вы действительно застряли, извините, вам придётся подождать до конца раунда."
LANG["UNSTUCK_CANNOT_FIND_SPOT"]		= "Невозможно найти место, куда вас переместить, телепортируемся на ближайшую точку возрождения."
LANG["UNSTUCK_SPAWNPOINTS_DISABLED"]	= "Вы собирались телепортироваться на ближайшую точку возрождения, но сервер запрещает это делать вне периода пряток/ослепления охотников. Извините!"
-- End of PHE/Plus

LANG["MISC_SEL_APPLY"]  = "Применить выделенное"
LANG["MISC_RESET_SEL"]  = "Сброс выбора"
LANG["MISC_RESET"]      = "Сброс"
LANG["MISC_CANCEL"]     = "Отмена"
LANG["MISC_SEL_ALL"]    = "Выбрать все"
LANG["MISC_SEL_NONE"]   = "Без выбора"

LANG["PHXM_CL_THIRDPERSON"]     = "Клавиша для режима от третьего лица"
LANG["PHXM_CL_UNSTUCK"]			= "Клавиша для телепортации (если застряли)"
LANG["CL_THIRDPERSON_ENABLED"]  = "Вид от третьего лица включён"
LANG["CL_THIRDPERSON_DISABLED"] = "Вид от третьего лица отключён"

LANG["PHX_TP_ADJUSTVIEW_BTN"]	= "Настройка вида от третьего лица" --Button, as well as window title.
LANG["PHX_TPS_ADJ_TITLE"]		= "Предупреждение режима от третьего лица"
LANG["PHX_TPS_ADJ_SVDESIRED"]	= "Настройка режима от третьего лица отключена: Использование желаемой позиции сервера."
LANG["PHX_TPS_ADJ_3PDIS"]		= "Режим от третьего лица отключён."
LANG["PHX_TPS_ADJ_BLIND"]		= "Вы ослеплены. Попробуйте ещё раз позже."
LANG["PHX_TPS_ADJ_NEEDALIVE"]	= "Для этого вам нужно быть живым охотником."

LANG["ANG_AXIS_DIST"]	= "Расстояние" -- or Forward
LANG["ANG_AXIS_RIGHT"]	= "Вправо"
LANG["ANG_AXIS_UP"]		= "Вверх"
LANG["VEC_POS_LEFT"]	= "Влево" --X
LANG["VEC_POS_FRONT"]	= "Вперёд" --Y?
LANG["VEC_POS_TOP"]		= "Вверх"  --Z

-- Key Hints
LANG["KEYHINT_HUNTER3P"] 	= "Вид от третьего лица охотника"
LANG["KEYHINT_SHOOT"]		= "Основная атака оружия"
LANG["KEYHINT_SEC"]			= "Дополнительная атака оружия"
LANG["KEYHINT_PICKUP"]		= "Подобрать объект/Взаимодействие"

LANG["KEYHINT_LMB"]			= "Перевоплотиться"
LANG["KEYHINT_RMB"]			= "Приманка/особая способность"
LANG["KEYHINT_RANDTAUNT"] 	= "Случайная насмешка"
LANG["KEYHINT_TAUNTMENU"] 	= "Меню насмешек"
LANG["KEYHINT_ROTATION"] 	= "Блокировка вращения"
LANG["KEYHINT_PROPMENU"] 	= "Меню объектов"
LANG["KEYHINT_FREEZEAIR"] 	= "Заморозка объекта"
LANG["KEYHINT_SPAWNDECOY"] 	= "Использ. приманку"
