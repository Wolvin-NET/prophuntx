...
-- Note: This are just an Example/Demo file and the Translations are OUTDATED. 
-- You still need to copy from original gamemode's language file, then change at the very bottom line from the file you copy and follow from this bottom line from "this" file.
-- Comments are trimmed to preserve disk space.
local LANG = {}

LANG.code = "en_??" -- Language ID. Can be 2 country code standard ("en") or with your preference ( "en_us", "en_uk", "pr-bz", ... )

LANG.Name 		 	= "English" -- example: "Bahasa Indonesia"
LANG.NameEnglish	= "English" -- Language in English, example: "Indonesian"
LANG.Author			= "YOUR NAME" -- Only accept STRINGS.
-- Can Accept: String of your URL or Table.
LANG.AuthorURL		= { 
	"https://steamcommunity.com/profiles/7656xxxxxxxxxxxx",
	"https://steamcommunity.com/profiles/7656123456789011"
}
-- Example of Multiple Strings
LANG.SUICIDEMSG = {
	"suicided!",
	"died mysteriously.",
	"died from magic.",
...
LANG["CHAT_SWAPBALANCEYOU"]		= "You were swapped to achieve perfect balance."
-- Example Multiline Text: F1 Help Text
...
-- If you copied from the gamemode file, change and copy this line:
list.Set("PHX.CustomExternalLanguage", "Custom Language: <Language>", LANG)