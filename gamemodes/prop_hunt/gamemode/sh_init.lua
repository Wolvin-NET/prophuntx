...
-- Convars.
-- WARNING: 
-- THIS CONVAR SECTIONS WILL BE CHANGED IN FUTURE. 
-- DUE TO REPLICATION PROBLEMS, ALL CONVAR OBJECTS ON CLIENTSIDE WILL USE NEW METHOD TO "GETGLOBAL*" FUNCTION INSTEAD OF GETTING A VALUE FROM CONVAR OBJECT.
